namespace System.Instant.Sqlset
{
    ...
    public class Sqlbase
    {
        ...
        public Sqlbase(SqlConnection SqlDbConnection) : this(SqlDbConnection.ConnectionString) { }
        ...
        public IDeck<IDeck<IFigure>> BulkDelete(
            IFigures cards,
            bool keysFromDeck = false,
            bool buildMapping = false,
        ...
        public IDeck<IDeck<IFigure>> BulkInsert(
            IFigures cards,
            bool keysFromDeck = false,
            bool buildMapping = false,
            BulkPrepareType tempType = BulkPrepareType.Trunc
        ...
        public IDeck<IDeck<IFigure>> Delete(
            IFigures cards,
            bool keysFromDeck = false,
            bool buildMapping = false,
            BulkPrepareType tempType = BulkPrepareType.Trunc
        ...
        public IDeck<IDeck<IFigure>> Insert(
            IFigures cards,
            bool keysFromDeck = false,
            bool buildMapping = false,
            BulkPrepareType tempType = BulkPrepareType.Trunc
