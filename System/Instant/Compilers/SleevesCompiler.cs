namespace System.Instant
{
    ...
    public class SleevesCompiler
    {
        ...
        {
            PropertyInfo prop = typeof(FigureSleeves).GetProperty(
                "Item",
                new Type[] { typeof(int) }
            );
            ...
            if (mutator != null)
            {
                ...
                il.EmitCall(
                    OpCodes.Callvirt,
                    typeof(IFigures).GetMethod(
                        "set_Item",
                        new Type[] { typeof(int), typeof(IFigure) }
                    ),
                    null
                );
                il.Emit(OpCodes.Ret);
        ...
        private void CreateItemByIntProperty(TypeBuilder tb)
        {
            ...
            if (accessor != null)
            {
                ...
                il.EmitCall(
                    OpCodes.Callvirt,
                    typeof(IFigures).GetMethod("get_Item", new Type[] { typeof(int), typeof(int) }),
                    null
                );
                il.Emit(OpCodes.Ret);
            }
