...
namespace System.Instant.Stock
{
    ...
    public class UnsafeMethods
    {
        ...
        internal static string GetMessage(int errorCode)
        {
            ...
            if (UnsafeMethods.FormatMessage(12800, IntPtr.Zero, errorCode, 0, stringBuilder, stringBuilder.Capacity,
                    IntPtr.Zero) != 0)
            {
        ...
        [SecurityCritical]
        internal static extern SafeMMFileHandle CreateFileMapping(SafeFileHandle hFile, IntPtr lpAttributes,
        ...
        internal static SafeMMViewHandle MapViewOfFile(SafeMMFileHandle hFileMappingObject,
            FileMapAccess dwDesiredAccess, ulong ddFileOffset, UIntPtr dwNumberofBytesToMap)
        {
