...
namespace System.Instant.Stock.Utilities
{
    public struct ArrayStockSlice : IList, ICollection
    {
        ...
        public ArrayStockSlice(IList list)
        {
            if (list == null)
        ...
        public ArrayStockSlice(IList list, int offset, int count)
        {
            if (list == null)
                throw new ArgumentNullException("list");
            if (offset < 0)
        ...
        {
            if (obj is ArrayStockSlice)
                return Equals((ArrayStockSlice)obj);
            else
                return false;
        }

        public bool Equals(ArrayStockSlice obj)
        {
            return obj._list == _list && obj._offset == _offset && obj._count == _count;
        }

        public static bool operator ==(ArrayStockSlice a, ArrayStockSlice b)
        {
            return a.Equals(b);
        }
        ...
        private sealed class ArraySliceEnumerator : IEnumerator
        {
            ...
            internal ArraySliceEnumerator(ArrayStockSlice arraySlice)
            {
