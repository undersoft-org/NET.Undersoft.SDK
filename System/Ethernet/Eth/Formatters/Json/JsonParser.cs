namespace System.Deal
{
    ...
    public class JsonParser
    {
        ...
        )
        {
            ...
            ISleeve sleeve = instance.ToSleeve();
            int i = 0;
        ...
        public static string ToJson(
            ...
            DealComplexity complexity = DealComplexity.Standard
        )
        {
    ...
    public static class JsonParserProperties
    {
        ...
        {
            { "System.Deal.DealHeader", new string[] { "Context", "Content" } },
            { "System.Deal.DealMessage", new string[] { "Notice", "Content" } },
            {
                "System.Deal.DealContext",
                new string[] { "Identity", "ContentType", "Complexity", "Echo" }
            },
            {
                "System.Deal.DealIdentity_Advanced",
                new string[] { "Id", "Name", "Key", "Token", "UserId", "DeptId", "Ip", "DataPlace" }
            },
            {
                "System.DealIdentity_Basic",
                new string[] { "UserId", "DeptId", "Token", "DataPlace", }
            },
            {
                "System.Core.NetdealIdentity",
                new string[] { "Name", "Key", "Token", "UserId", "DeptId", "DataPlace", }
            },
            {
                "System.Core.NetdealIdentity_Guide",
                new string[] { "Token", "UserId", "DeptId", "DataPlace" }
            },
            {
                "System.FigureAs.DataArea",
                new string[] { "SpaceName", "DisplayName", "Config", "State", "Areas" }
            },
            { "System.FigureAs.DataArea_Guide", new string[] { "SpaceName", "Areas", "Config" } },
            {
            ...
            },
            {
                ...
                new string[] { "CatalogsId", "Catalogs", "CatalogsIn", "Config" }
            },
            {
            ...
            },
            {
                ...
                new string[] { "CatalogId", "Deckises", "CatalogsIn", "Config" }
            },
            {
            ...
            { "System.FigureAs.Deck_Guide", new string[] { "DeckName", "Config" } },
            {
            ...
            { "System.FigureAs.DataField", new string[] { "Value" } },
            {
            ...
            },
            {
                ...
                new string[] { "Index", "RubricName", "Operand", "Value", "Logic", "Stage", }
            },
            { "System.FigureAs.SortTerm", new string[] { "Index", "RubricName", "Direction" } },
            {
                "System.Core.Settings",
                new string[] { "Place", "DataIdx", "Path", "NetdealIdx", "DataType" }
            },
            { "System.Core.Settings_Guide", new string[] { "Place", "DataIdx", "DataType" } },
            {
                "System.Core.Settings_Basic",
                new string[] { "Place", "DataIdx", "NetdealIdx", "DataType" }
            },
            {
            ...
            },
            {
                ...
                new string[] { "Page", "PageActive", "CachedPages", "PageCount", "PageSize", }
            },
            { "System.FigureAs.Relatings", new string[] { "ChildRelations", "ParentRelations" } },
            { "System.FigureAs.Relation", new string[] { "RelationName", "Parent", "Child", } },
            { "System.FigureAs.RelationMember", new string[] { "DeckName", "RelationKeys" } }
        };

        public static PropertyInfo[] GetJsonProperties<T>(
            DealComplexity complexity = DealComplexity.Standard
        )
        {
            Type type = typeof(T);
        ...
        public static PropertyInfo[] GetJsonProperties(
            this Type type,
            DealComplexity complexity = DealComplexity.Standard
        )
        {
